...
HelpWindow::HelpWindow() {
    ...
    //-- Agent
    xAngelSensor = helpWindowLength + modelScale * 0.02;
    yAngelSensor = helpWindowWidth * modelScale * 0.82;
    xGainValue = helpWindowLength + modelScale  * 0.02;
    yGainValue = helpWindowWidth + modelScale * 5.4;
...
void HelpWindow::updateHelpWindow(bool value) {
    ...
    if (behaviourMode) {
        ...
        //-- Position
        //-- Gain Value:
        putText(helpWin, "Gain Value : " + gainInfo , Point(xGainValue,yGainValue), FONT_HERSHEY_SIMPLEX, helpWindowFontSize * 0.7, Scalar(95,169,225));
        //-AngelSensor
        putText(helpWin, "Angle Sensor: " + angelInfo , Point(xAngelSensor, yAngelSensor), FONT_HERSHEY_SIMPLEX, helpWindowFontSize * 0.7, Scalar(95,169,225));
        //- X
...
void HelpWindow::viewPosition(double inputX, double inputY, double inputTheta, double Gaussian_noise, float gain_value) {
    ostringstream x;
    ostringstream y;
    ostringstream theta;
    ostringstream angelSensor;
    ostringstream GainValue;
    modelX = inputX;
    modelY = inputY;
    ...
    angelSensor << setprecision(4);
    GainValue << setprecision(2);
    x << fixed;
    y << fixed;
    theta << fixed;
    angelSensor << fixed;
    ...
    y << inputY;
    theta << inputTheta;
    angelSensor << Gaussian_noise ;
    GainValue <<  gain_value;
    xInfo = x.str();
    yInfo = y.str();
    thetaInfo = theta.str();
    angelInfo = angelSensor.str();
    gainInfo = GainValue.str();
}
